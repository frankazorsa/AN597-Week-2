...
x1
strsplit(x1,'')
#In order to select every third element of this vector I used the same function as above.
c <- 1:97
...
#Listing previous taxons in one group.
Anthropoidea<-list(platyrrhini,Catarrhini)

#Namming the row and creating a new vector
names(Anthropoidea)<-c("platyrrhini","Catarrhini")

#Vector
Tarsioidea<-c("Tarsiidae")

#Listing above taxons in one group.
...
trepsirhini<-list(Lorisoidea,Lemuroidea)
...
bdf <- as.data.frame(b)
bdf
#As a data frame, coerce the second column to tbe logical-valued
bdf[,2] = as.logical(2)
bdf
